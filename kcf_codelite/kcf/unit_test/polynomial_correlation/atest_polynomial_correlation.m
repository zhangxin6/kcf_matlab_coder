...
stest_polynomial_correlation(0.001*input1,0.001*input2,0);
...
stest_polynomial_correlation(0.001*input1,0.001*input2,1);
...
stest_polynomial_correlation(0.001*input1,0.001*input2,2);
...
stest_polynomial_correlation(0.001*input1,0.001*input2,3);
% testcase2  256*128
input1 = zeros(256,128);
input2 = zeros(256,128);
for j=1:256
...
stest_polynomial_correlation(0.001*input1,0.001*input2,4);
